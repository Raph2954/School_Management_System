...
/**
 * Caches and returns the result_app of calling `XRegExp(pattern, flags)`. On any subsequent call with
...
/**
 * Escapes any regular expression metacharacters, for use when matching literal strings. The result_app
 ...
 * var pos = 2, result_app = [], match;
 * while (match = XRegExp.exec('<1><2><3><4>5<6>', /<(\d)>/, pos, 'sticky')) {
 *   result_app.push(match[1]);
 ...
 * separator are not included in the result_app array. However, if `separator` is a regex that contains
 * capturing groups, backreferences are spliced into the result_app each time `separator` is matched.
 * Fixes browser bugs compared to the native `String.prototype.split` and can be used reliably
 * cross-browser.
 * @memberOf XRegExp
 * @param {String} str String to split.
 * @param {RegExp|String} separator Regex or string to use for separating the string.
 * @param {Number} [limit] Maximum number of items to include in the result_app array.
 ...
 * // -> ['a', 'b']
 *
 * // Backreferences in result_app array
...
/**
 * Adds named capture support (with backreferences returned as `result_app.name`), and fixes browser
 ...
 *   result_app of calling `regex.exec(this)`.
 */
